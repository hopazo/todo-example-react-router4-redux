# Demo de [React Router v4](https://reacttraining.com/react-router/) y [React Router Redux](https://github.com/ReactTraining/react-router/tree/master/packages/react-router-redux)
